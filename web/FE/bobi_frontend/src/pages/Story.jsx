...
function Story() {
  ...
  return (
    <React.Fragment>
      ...
      <div>
        ...
        <span
          style={{
            ...
            marginLeft: "2%",
            textShadow:
              "-1px 0 #FFC0CB, 0 1px #FFC0CB, 1px 0 #FFC0CB, 0 -1px #FFC0CB",
          }}
        >
          {exp}
        </span>
      ...
      <StoryItem1 />
      {exp < 100 ? <HiddenStory /> : <StoryItem2 />}
      {exp < 200 ? <HiddenStory /> : <StoryItem3 />}
      {exp < 300 ? <HiddenStory /> : <StoryItem4 />}
      {exp < 400 ? <HiddenStory /> : <StoryItem5 />}
    </React.Fragment>
  );
}
