...
faceCascade = cv2.CascadeClassifier(thisPath + '/output2.xml')
...
class CVThread(threading.Thread):
    ...
    def elementDraw(self,imgInput):
        ...
        elif self.CVMode == 'findColor':   # findColor 관련 부분 ========================================================================================================================================
            if self.findColorDetection:
                #cv2.putText(imgInput,'Target Detected',(40,60), CVThread.font, 0.5,(255,255,255),1,cv2.LINE_AA)
                cv2.putText(imgInput,'%d Target Detected'%len(CVThread.tor),(40,60), CVThread.font, 0.5,(255,255,255),1,cv2.LINE_AA)
                ...
                #cv2.putText(imgInput,CVThread.tor,(40,60), CVThread.font, 0.5,(255,255,255),1,cv2.LINE_AA)
                self.drawing = 0
