            ...
            <div id="controls" class="control-container">
                <table>
                    ...
                    <tr>
                        ...
                        <td align="center"><button class="button button4" id="Jump" onclick="fetch(document.location.origin+'/control?var=funcMode&val=4&cmd=0');">left_test</button></td>
                    </tr>
                    <tr>
                        <td align="center"><button class="button button4" id="actionA" onclick="fetch(document.location.origin+'/control?var=funcMode&val=5&cmd=0');">down_test</button></td>
                        <td align="center"><button class="button button4" id="actionB" onclick="fetch(document.location.origin+'/control?var=funcMode&val=6&cmd=0');">stand_test</button></td>
                    ...
                    <tr>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=funcMode&val=10&cmd=0');">Sit</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=funcMode&val=11&cmd=0');">StandUp</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=sset&val=3&cmd=1');">3_SET</button></td>
                    </tr>


                    <tr>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=funcMode&val=12&cmd=0');">LefthHand</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=funcMode&val=13&cmd=0');">RightHand</button></td>
                    ...
                    <tr>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=funcMode&val=14&cmd=0');">Lower</button></td>
                        <td align="center"><button class="button" onclick="fetch(document.location.origin+'/control?var=funcMode&val=15&cmd=0');">Upper</button></td>
