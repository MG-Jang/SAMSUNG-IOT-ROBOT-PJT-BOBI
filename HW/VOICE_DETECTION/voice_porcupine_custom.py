...
#
# reference 
#   picovoice's porcupine_demo_mic.py
'''
import argparse
import os
import struct
...
# flag for hot word detection, reading in voice.py
hot_word_flag = 0
...
class PorcupineCustom(Thread):
    def __init__(
            ...
            library_path,
            sensitivities,
            model_path='/home/pi/WAVEGO/RPi/voice_data/porcupine_params_ko.pv',
            keyword_paths='/home/pi//WAVEGO/RPi/voice_data/hi_bobi_ko_rpi.ppn',
        ...
        super(PorcupineCustom, self).__init__()
    ...
    def run(self):
        """
         ...
         execute while the thread is alive
         """
...
def porcupine_parsing():
    """Parse the args and check if nessesary args are given

    Raises:
        ValueError: access key of porcupine is required
        ValueError: keywords or keywords_paths should be given
        ValueError: sensitivities should be defined for all keywords
    ...
    if args.show_audio_devices:
        PorcupineCustom.show_audio_devices()
    else:
