...
class Speaker():
    def __init__(self):
        self.prev_closeness = sensor_mysql.closeness
    ...
    def is_new_story_available(self):
        result = False
        if(self.prev_closeness < 100 and sensor_mysql.closeness>=100):
            result = True 
        elif(self.prev_closeness < 200 and sensor_mysql.closeness>=200):
            result = True 
        elif(self.prev_closeness < 300 and sensor_mysql.closeness>=300):
            result = True
        elif(self.prev_closeness < 400 and sensor_mysql.closeness>=400):
            result = True
